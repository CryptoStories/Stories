...
uint256 hashGenesisBlock("0x00000000764294e49869795cd27e3adce315780a5c669cb7009ec28182af45c0");
...
bool LoadBlockIndex()
{
    if (fTestNet)
    {
        ...
        hashGenesisBlock = uint256("0x00000000764294e49869795cd27e3adce315780a5c669cb7009ec28182af45c0");
    }
...
bool InitBlockIndex() {
    ...
    if (!fReindex) {
        // Genesis block
        const char* pszTimestamp = "Mtgox BTCUSD 2014-02-05T17:13:29; last:915.00 buy:915.00 sell:916.00";
        CTransaction txNew;
        txNew.vin.resize(1);
        txNew.vout.resize(1);
        ...
        block.nVersion = 1;
        block.nTime    = 1391620424;
        block.nBits    = 486604799;
        block.nNonce   = 1036035554;
        ...
        assert(block.hashMerkleRoot == uint256("0x7e0239de9c2f14926721bfa3dab8093701bee595a86460306acfd70de6eb5b4c"));
        block.print();
